 ...
 * @author koichik
 */
public class TransactionLogTableInitializationFailedException extends
        RuntimeException {
     ...
     * @param cause
     */
    public TransactionLogTableInitializationFailedException(
            final TransactionLogManager transactionLogManager,
            final Throwable cause) {
        super(TRANSACTION_LOG_TABLE_INITIALIZATION_FAILED
            .format(transactionLogManager), cause);
    }
