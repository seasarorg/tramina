 ...
 * @author koichik
 */
public class RollbackSubtransactionFailedException extends SystemException {

    /**
     * @param configurable
     */
    public RollbackSubtransactionFailedException(final TraminaTransaction tx,
            final XAResource xaResource, final Throwable cause) {
        super(ROLLBACK_SUBTRANSACTION_FAILED.format(tx, xaResource));
        initCause(cause);
    }
