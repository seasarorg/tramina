...
import org.seasar.tramina.activity.Startable;
 ...
 * @author koichik
 */
public abstract class AbstractActiveComponent<T extends AbstractActiveComponent<T>>
        implements Component, Initializable<T>, Startable<T>, Disposable<T> {
    ...
    // /////////////////////////////////////////////////////////////////
    // instance methods from Startable
    //
    @Override
    public T start() throws NotInitializedException, AlreadyStartedException {
        assertInitialized(this);
        assertBeforeStarted(this);
        doStart();
    ...
    @Override
    public T stop() throws NotStartedException, AlreadyStoppedException {
        assertStarted(this);
        doStop();
