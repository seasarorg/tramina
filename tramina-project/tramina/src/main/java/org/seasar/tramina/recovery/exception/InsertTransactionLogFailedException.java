 ...
 * @author koichik
 */
public class InsertTransactionLogFailedException extends SystemException {

    /**
     * @param message
     * @param cause
     */
    public InsertTransactionLogFailedException(
            final TransactionLogManager transactionLogManager,
            final TraminaTransaction transaction, final Throwable cause) {
        super(INSERT_TRANSACTION_LOG_FAILED.format(
