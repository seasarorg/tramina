 ...
 * @author koichik
 */
public class InterfaceNotImplementedException extends SQLException {

    /**
     * @param configurable
     */
    public InterfaceNotImplementedException(
            final ResourceManager resourceManager, final Class<?> iface) {
        super(INTERFACE_NOT_IMPLEMENTED.format(resourceManager, iface));
    }
