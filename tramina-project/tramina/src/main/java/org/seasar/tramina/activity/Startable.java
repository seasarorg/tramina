 ...
 * @author koichik
 */
public interface Startable<T extends Startable<T>> {

    T start() throws NotInitializedException, AlreadyStartedException;

    T stop() throws NotStartedException, AlreadyStoppedException;
