 ...
 * @author koichik
 */
public class BeginSubtransactionFailedException extends SystemException {

    /**
     * @param configurable
     */
    public BeginSubtransactionFailedException(final TraminaTransaction tx,
            final XAResource xaResource, final Throwable cause) {
        super(BEGIN_SUBTRANSACTION_FAILED.format(tx, xaResource));
        initCause(cause);
    }
