 ...
 * @author koichik
 */
public class CommitSubtransactionFailedException extends SystemException {

    /**
     * @param configurable
     */
    public CommitSubtransactionFailedException(final TraminaTransaction tx,
            final XAResource xaResource, final Throwable cause) {
        super(COMMIT_SUBTRANSACTION_FAILED.format(tx, xaResource));
        initCause(cause);
    }
